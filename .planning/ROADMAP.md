...
**Plans**: 2 plans
  - [x] 09-01-PLAN.md — Preview.tsx ResizeObserver auto-fit scale + pages.css print reset (Wave 1)
  - [x] 09-02-PLAN.md — Human verification of auto-fit zoom behavior (Wave 2)
**UI hint**: yes
